 <footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    <h5>Our Address</h5>
                    <address>
		              PRESIDENCY UNIVERSITY,Itgallpura<br>
		              Bengaluru - 587 203, Karnataka<br>		              
		              <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+919482038504"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="tel:+918233294006"> <i class="fa fa-fax"></i> Fax</a>
                    <a role="button" class="btn btn-success" href="mailto:CHETAN.20201CAI0158@presidencyuniversity.in"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>				
       ...
       <button target="_blank" href="/" rel="nofollow" class="btn btn-icon-only btn-linkedin rounded-circle" data-toggle="tooltip" data-original-title="Mail Us">
          ...
          <button target="_blank" href="/" rel="nofollow" class="btn btn-icon-only btn-github rounded-circle" data-toggle="tooltip" data-original-title="Star on Github">
           ...
           <div class="row justify-content-center">             
                     <div class="col-auto">					
                    <p>&copy; Copyright 2023 CROP PROTECTION MANAGEMENT SYSTEM, All Rights Reserved </p>
                </div>
           </div>
        </div>
    </footer>
