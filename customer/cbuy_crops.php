			...
			<?php
							...
							require_once "StripePayment/config.php";
								...
								$session = \Stripe\Checkout\Session::create([
									...
									'mode' => 'payment',
									'success_url' => 'http://localhost/htdocs/agriculture_portal/customer/cupdatedb.php',
									'cancel_url' => 'http://localhost/htdocs/agriculture_portal/customer/cbuy_crops.php',
								]);
